...
const routes: Routes = [
  ...
  { path: 'builder/:id', loadChildren: '../builder/builder.module#BuilderModule', canActivate: [DomainGuard] },
  { path: 'websites/:id', loadChildren: '../website/website.module#WebsiteModule', canActivate: [DomainGuard] },
